...
def project_delete(request, proj_id):
    ...
    if (request.user.username == project.user.username) or (request.user.is_superuser):
        project.delete()
        return render_to_response('projects/delete.html', context=RequestContext(request,{}))
    else:
        return render_to_response('projects/no_delete.html', context=RequestContext(request,{}))
...
def project_saved(request):
    ...
    return render_to_response('projects/saved.html',
